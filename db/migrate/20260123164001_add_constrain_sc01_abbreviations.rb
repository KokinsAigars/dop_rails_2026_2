...
class AddConstrainSc01Abbreviations < ActiveRecord::Migration[8.1]
  ...
  def down
    ...
    remove_index "sc_01_abbreviations.abbr_books_periodicals", name: "idx_abbr_books_periodicals_abbr_name"
    remove_index "sc_01_abbreviations.abbr_books_periodicals", name: "idx_abbr_books_periodicals_abbr_letter"
    remove_index "sc_01_abbreviations.abbr_books_periodicals", name: "uq_abbr_books_periodicals_root_version"
    remove_index "sc_01_abbreviations.abbr_books_periodicals", name: "uq_abbr_books_periodicals_root_current"
    remove_index "sc_01_abbreviations.abbr_books_periodicals", name: "idx_abbr_books_periodicals_superseded_at"

    remove_index "sc_01_abbreviations.abbr_general_terms", name: "idx_abbr_general_terms_letter_name"
    remove_index "sc_01_abbreviations.abbr_general_terms", name: "idx_abbr_general_terms_name"
    remove_index "sc_01_abbreviations.abbr_general_terms", name: "uq_abbr_general_terms_root_version"
    remove_index "sc_01_abbreviations.abbr_general_terms", name: "uq_abbr_general_terms_root_current"

    remove_index "sc_01_abbreviations.abbr_grammatical_terms", name: "idx_abbr_gram_terms_letter_name"
    remove_index "sc_01_abbreviations.abbr_grammatical_terms", name: "idx_abbr_gram_terms_name"
    remove_index "sc_01_abbreviations.abbr_grammatical_terms", name: "uq_abbr_gram_terms_root_version"
    remove_index "sc_01_abbreviations.abbr_grammatical_terms", name: "uq_abbr_gram_terms_root_current"

    remove_index "sc_01_abbreviations.abbr_publication_sources", name: "idx_abbr_pub_sources_name"
    remove_index "sc_01_abbreviations.abbr_publication_sources", name: "uq_abbr_pub_sources_root_version"
    remove_index "sc_01_abbreviations.abbr_publication_sources", name: "uq_abbr_pub_sources_root_current"

    remove_index "sc_01_abbreviations.abbr_typographicals", name: "idx_abbr_typographicals_name"
    remove_index "sc_01_abbreviations.abbr_typographicals", name: "uq_abbr_typographicals_root_version"
    remove_index "sc_01_abbreviations.abbr_typographicals", name: "uq_abbr_typographicals_root_current"

    remove_index "sc_01_abbreviations.abbr_docs", name: "idx_abbr_docs_doc_title"
    remove_index "sc_01_abbreviations.abbr_docs", name: "uq_abbr_docs_root_version"
    remove_index "sc_01_abbreviations.abbr_docs", name: "uq_abbr_docs_root_current"
