...
class CreateSc03Dictionary < ActiveRecord::Migration[8.1]
  def change
    ...
    # dic_vocab (composite PK) — no standard block here
    create_table "sc_03_dictionary.dic_vocab", id: false do |t|
      t.column :lang, "sc_03_dictionary.dic_lang", null: false
      t.text   :term,      null: false
      t.text   :term_norm, null: false
      t.timestamp :created_at, null: false, default: -> { "CURRENT_TIMESTAMP" }
    end

    execute <<~SQL
      ALTER TABLE sc_03_dictionary.dic_vocab
