...
class CreateSc02Bibliography < ActiveRecord::Migration[8.1]
  def change
    ...
    create_table "sc_02_bibliography.ref_bibliography", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.text :ref_letter
      t.text :ref_abbrev
    ...
    create_table "sc_02_bibliography.ref_internet_sources", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.text :ref_title
      t.text :ref_url
    ...
    create_table "sc_02_bibliography.ref_texts", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.text :ref_texts_no
    ...
    create_table "sc_02_bibliography.ref_doc", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.text  :doc_title
      t.text  :doc_license
