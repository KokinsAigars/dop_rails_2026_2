...
class CreateSc06DicOcr < ActiveRecord::Migration[8.1]
  def up
    ...
    # 1) ocr_source_doc
    create_table "sc_06_ocr.ocr_source_doc",
                 id: :uuid,
    ...
    # 2) ocr_page
    create_table "sc_06_ocr.ocr_page",
                 id: :uuid,
                 default: -> { "gen_random_uuid()" } do |t|
    ...
    # 3) ocr_run
    create_table "sc_06_ocr.ocr_run",
                 id: :uuid,
                 default: -> { "gen_random_uuid()" } do |t|
    ...
    # 4) ocr_page_result
    create_table "sc_06_ocr.ocr_page_result",
                 id: :uuid,
                 default: -> { "gen_random_uuid()" } do |t|
    ...
    # 5) ocr_token
    create_table "sc_06_ocr.ocr_token",
                 id: :uuid,
                 default: -> { "gen_random_uuid()" } do |t|
    ...
    # 6) ocr_review
    create_table "sc_06_ocr.ocr_review",
                 id: :uuid,
                 default: -> { "gen_random_uuid()" } do |t|
      t.uuid :fk_page_result_id, null: false
    ...
    # 7) ocr_link
    create_table "sc_06_ocr.ocr_link",
                 id: :uuid,
                 default: -> { "gen_random_uuid()" } do |t|
      t.uuid :fk_page_result_id, null: false
