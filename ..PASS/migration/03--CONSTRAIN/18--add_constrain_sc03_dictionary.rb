...
class AddConstrainSc03Dictionary < ActiveRecord::Migration[8.1]
  ...
  def down
    ...
    remove_index "sc_03_dictionary.dic_index", name: "uq_dic_index_source_file_order", if_exists: true
    remove_index "sc_03_dictionary.dic_index", name: "ix_dic_index_homograph_uuid", if_exists: true
    remove_index "sc_03_dictionary.dic_index", name: "ix_dic_index_source_file", if_exists: true

    remove_index "sc_03_dictionary.dic_entry", name: "uq_dic_entry_per_index", if_exists: true
    remove_index "sc_03_dictionary.dic_entry", name: "ix_dic_entry_fk_index", if_exists: true
    remove_index "sc_03_dictionary.dic_entry", name: "ix_dic_entry_lang_name", if_exists: true
    remove_index "sc_03_dictionary.dic_entry", name: "ix_dic_entry_revision", if_exists: true

    remove_index "sc_03_dictionary.dic_scan", name: "uq_dic_scan_per_index_version", if_exists: true

    remove_index "sc_03_dictionary.dic_ref", name: "ix_dic_ref_fk_index", if_exists: true
    remove_index "sc_03_dictionary.dic_ref", name: "ix_dic_ref_fk_entry", if_exists: true
    remove_index "sc_03_dictionary.dic_ref", name: "ix_dic_ref_index_entry", if_exists: true

    remove_index "sc_03_dictionary.dic_eg", name: "ix_dic_eg_fk_entry", if_exists: true
    remove_index "sc_03_dictionary.dic_eg", name: "ix_dic_eg_index_entry", if_exists: true

    remove_index "sc_03_dictionary.dic_quote", name: "ix_dic_quote_fk_index", if_exists: true
    remove_index "sc_03_dictionary.dic_quote", name: "ix_dic_quote_fk_entry", if_exists: true
    remove_index "sc_03_dictionary.dic_quote", name: "ix_dic_quote_index_entry", if_exists: true

    remove_index "sc_03_dictionary.dic_note", name: "ix_dic_note_fk_entry", if_exists: true
    remove_index "sc_03_dictionary.dic_note", name: "ix_dic_note_fk_index", if_exists: true
    remove_index "sc_03_dictionary.dic_note", name: "ix_dic_note_index_entry", if_exists: true

    # drop versioning indexes
    TABLES.each do |t|
      remove_index "sc_03_dictionary.#{t}", name: "uq_#{t}_root_version", if_exists: true
      remove_index "sc_03_dictionary.#{t}", name: "uq_#{t}_root_current", if_exists: true
    end
