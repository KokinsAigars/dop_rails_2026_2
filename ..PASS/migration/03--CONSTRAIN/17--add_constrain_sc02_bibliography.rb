...
class AddConstrainSc02Bibliography < ActiveRecord::Migration[8.1]
  ...
  def down
    ...
    remove_index "sc_02_bibliography.ref_bibliography", name: "idx_ref_bibliography_ref_abbrev", if_exists: true
    remove_index "sc_02_bibliography.ref_bibliography", name: "idx_ref_bibliography_ref_letter", if_exists: true
    remove_index "sc_02_bibliography.ref_bibliography", name: "idx_ref_bibliography_ref_type", if_exists: true

    remove_index "sc_02_bibliography.ref_internet_sources", name: "idx_ref_internet_sources_ref_url", if_exists: true

    remove_index "sc_02_bibliography.ref_texts", name: "idx_ref_texts_ref_abbrev", if_exists: true
    remove_index "sc_02_bibliography.ref_texts", name: "idx_ref_texts_ref_texts_no", if_exists: true

    remove_index "sc_02_bibliography.ref_doc", name: "idx_ref_doc_doc_title", if_exists: true

    # drop versioning indexes
    TABLES.each do |t|
      remove_index "sc_02_bibliography.#{t}", name: "uq_#{t}_root_version", if_exists: true
      remove_index "sc_02_bibliography.#{t}", name: "uq_#{t}_root_current", if_exists: true
    end
